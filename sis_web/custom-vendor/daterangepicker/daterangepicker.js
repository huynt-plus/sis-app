...
!function ($, moment) {
	...
	DateRangePicker.prototype = {
		...
		show: function (e) {
			...
			$(document).on('click.daterangepicker', '.popover-inner', $.proxy(this.outsideClick, this));
		...
		updateInputText: function () {
			if (this.element.is('input') && !this.singleDatePicker) {
				...
				if (span && !this.singleDatePicker) {
					span.html(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
				} else if (span) {
					span.html(this.startDate.format(this.format));
				}
			}
		},

		findSpanElement: function () {
